...
{dm} works well and is at its most powerful when used on databases — integration into {dbplyr} workflows with MSSQL and Postgres DBMS is easy as pie (support for more databases will follow in future versions).
...
cdm_copy_to(dplyr::src_postgres(), dm = cdm_nycflights13())
